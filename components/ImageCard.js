...
const ImageCard = ({ image, onDownload, searchKeyword, index }) => {
  ...
  return React.createElement(
    ...
    {
      className:
        "group bg-gray-800 rounded-lg shadow-xl p-3 flex flex-col justify-between overflow-hidden transition-all duration-300 ease-in-out hover:shadow-purple-500/50 transform hover:-translate-y-1 relative",
    },
    React.createElement(
      "div",
      {
        className:
          "aspect-square w-full overflow-hidden rounded-md mb-3 bg-gray-700 flex items-center justify-center",
      },
    ...
    React.createElement(
      "button",
      {
        ...
        className:
          "w-full whitespace-nowrap py-2.5 px-4 text-sm font-semibold rounded-md bg-purple-600 text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-75 transition-all duration-200 transform active:scale-95",
