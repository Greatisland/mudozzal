...
const SearchBar = ({ onSearch, loading }) => {
  ...
  return React.createElement(
    "form",
    {
      ...
      className:
        "flex flex-col sm:flex-row items-stretch sm:items-center my-6 sm:my-8 gap-3 w-full max-w-xl",
    },
    React.createElement(
      "div",
      ...
      inputError &&
        React.createElement(
          ...
          {
            id: "keyword-error",
            className: "text-red-400 text-sm mt-1.5 px-1",
          },
          inputError
        )
    ),
